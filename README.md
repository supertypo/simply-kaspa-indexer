...
--exclude-fields=block_accepted_id_merkle_root,block_merge_set_blues_hashes,block_merge_set_reds_hashes,block_selected_parent_hash,block_transaction_ids,block_bits,block_blue_work,block_daa_score,block_hash_merkle_root,block_nonce,block_pruning_point,block_utxo_commitment,block_version,tx_hash,tx_mass,tx_payload,tx_block_hash,tx_in_signature_script,tx_in_sig_op_count,tx_out_script_public_key_address
```
...
Options:
  ...
  -c, --initialize-db
      ...
      --exclude-addresses <EXCLUDE_ADDRESSES>
          Exclude specific addresses (ex prefix) from addresses/scripts_transactions.
```
